export default function BuilderPage() {
  return (
    <div className="flex items-center flex-col pt-10 px-5 min-h-screen bg-base-100 text-gray-800 dark:text-gray-200">
      <div className="max-w-xl w-full border border-gray-600 shadow-[4px_4px_0_#666] bg-[#c0c0c0] dark:bg-[#1a1a1a] rounded-sm font-[Tahoma,Geneva,Verdana,sans-serif]">
        ...
        <div className="p-8">
          ...
          <div className="mb-6 max-w-md mx-auto border border-gray-600 bg-[#d8d8d8] dark:bg-[#252525] rounded-sm p-4">
            ...
            <div className="flex justify-center mb-2">
              <code className="text-sm break-all px-3 py-2 rounded bg-white dark:bg-[#1a1a1a] text-gray-800 dark:text-gray-200 border border-gray-500 font-semibold shadow-inner">
