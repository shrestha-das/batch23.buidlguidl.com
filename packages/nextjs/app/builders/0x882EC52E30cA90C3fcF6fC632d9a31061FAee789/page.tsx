    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="flex justify-center">
          <BlockieAvatar address={BUILDER_ADDRESS} size={120} ensImage={ensAvatar || undefined} />
        </div>

        {/* Name */}
        <div className="text-center">
          <h1 className="text-3xl font-bold">thisbetom.eth</h1>
        </div>

        {/* Bio */}
        <div className="text-center">
          <p className="text-lg opacity-80">Goose Farmer</p>
        </div>

        {/* Address */}
        <div className="text-center">
          <code className="text-sm opacity-60">{BUILDER_ADDRESS}</code>
        </div>
